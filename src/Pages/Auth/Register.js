      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 overflow-y-auto">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-10 my-4">
          <div className="mb-6 sm:mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold mb-2 text-gray-900">Create Account!</h2>
            <p className="text-sm text-gray-600">Join us to start your learning journey.</p>
          </div>
