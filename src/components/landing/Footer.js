...
const Footer = () => {
  return (
    <footer id="contactUs" className="bg-card border-t border-border">
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-20">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary/20 hover:text-primary transition-colors duration-200"
                >
        ...
        {/* Divider */}
        <div className="glow-line opacity-30 mb-8" />
